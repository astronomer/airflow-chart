...
| `triggerer.replicas`                                  | How many Airflow Triggerer replicas should run                                                            | `1`                                                               |    |
| `triggerer.command`                                   | Command to use when running Airflow triggerers (templated)                                                | `~`                                                               |    |
| `triggerer.args`                                      | Args to use when running Airflow triggerer (templated)                                                    | `["airflow", "triggerer"]`                                        |    |
| `triggerer.strategy`                                  | The strategy used to replace old Pods by new ones when persistence is not enabled.                        | `{"rollingUpdate": {"maxSurge": "100%", "maxUnavailable": "50%"}` |    |
| `triggerer.terminationGracePeriodSeconds`             | How long Kubernetes should wait for Celery workers to gracefully drain before force killing               | `600`                                                             |    |
| `triggerer.resources.limits.cpu`                      | CPU Limit of triggerer                                                                                    | `~`                                                               |    |
| `triggerer.resources.limits.memory`                   | Memory Limit of triggerer                                                                                 | `~`                                                               |    |
| `triggerer.resources.requests.cpu`                    | CPU Request of triggerer                                                                                  | `~`                                                               |    |
| `triggerer.resources.requests.memory`                 | Memory Request of triggerer                                                                               | `~`                                                               |    |
| `triggerer.airflowLocalSettings`                      | Custom Airflow local settings python file                                                                 | `~`                                                               |    |
| `triggerer.safeToEvict`                               | Allow Kubernetes to evict triggerer pods if needed (node downscaling)                                     | `true`                                                            |    |
| `triggerer.extraContainers`                           | Extra containers for the triggerer                                                                        | `[]`                                                              |    |
| `triggerer.extraInitContainers`                       | Extra init containers for the triggerer                                                                   | `[]`                                                              |    |
| `triggerer.extraVolumes`                              | Extra volumes for the triggerer                                                                           | `[]`                                                              |    |
| `triggerer.extraVolumeMounts`                         | Extra volume mounts for the triggerer                                                                     | `[]`                                                              |    |
| `triggerer.livenessProbe.initialDelaySeconds`         | Triggerer LivenessProbe initial delay                                                                     | `15`                                                              |    |
| `triggerer.livenessProbe.timeoutSeconds`              | Triggerer LivenessProbe timeout seconds                                                                   | `30`                                                              |    |
| `triggerer.livenessProbe.failureThreshold`            | Triggerer LivenessProbe failure threshold                                                                 | `20`                                                              |    |
| `triggerer.livenessProbe.periodSeconds`               | Triggerer LivenessProbe period seconds                                                                    | `5`                                                               |    |
| `triggerer.nodeSelector`                              | Node labels for pod assignment                                                                            | `{}`                                                              |    |
| `triggerer.tolerations`                               | Toleration labels for pod assignment                                                                      | `[]`                                                              |    |
| `triggerer.affinity`                                  | Affinity labels for pod assignment                                                                        | `{}`                                                              |    |
